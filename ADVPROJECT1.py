...
lbl_T1 = Label(Tops, text = " BODY MASS INDEX ", padx = 16, pady = 16, bd = 16, fg = '#000000', font = ("arial", 54, 'bold'), bg = "gray", relief = 'raise', width = 32, height = 1)
lbl_T1.pack()
...
lbl_h = Label(frame1B, text = "Enter Height in Meters Squared (1cm = 0.01m²)", font = ('arial', 20, 'bold'), bd = 20).grid(row = 0, column = 0)
t_h = Entry(frame1B, textvariable = variable2, font = ('arial', 16, 'bold'), bd = 16, width = 22, justify = 'center')
t_h.grid(row = 1, column = 0)

lbl_res_bmi = Label(frame1B, padx = 16, pady = 16, bd = 16, fg = '#000000', font = ('arial', 30, 'bold'), bg = 'gray', relief = 'sunk', width = 34, height = 1)
...
bmi_tab_text_lbl.insert(END, 'BMI RESULT \t\t' + "BMI CLASSIFICATION \n\n")
bmi_tab_text_lbl.insert(END, '18. 5 - BELOW \t\t' + "UNDERWEIGHT \n\n")
bmi_tab_text_lbl.insert(END, '18. 6 - 24. 9 \t\t' + "NORMAL WEIGHT \n\n")
bmi_tab_text_lbl.insert(END, '25 - 29. 9 \t\t' + "OVERWEIGHT \n\n")
bmi_tab_text_lbl.insert(END, '30 - 34. 9 \t\t' + "OBESE CLASS I \n\n")
bmi_tab_text_lbl.insert(END, '35 - 39. 9 \t\t' + "OBESE CLASS II \n\n")
bmi_tab_text_lbl.insert(END, '40 - ABOVE \t\t' + "OBESE CLASS III \n\n")

BMI_BUTTON = Button(frame2, text = "Click to \nCheck Your \nBMI", padx = 8, pady = 8, bd = 12, bg = 'gray', width = 21, font = ("arial", 20, 'bold'), height = 3, command = BodyMassIndex_Calculator)
